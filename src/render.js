...
document.getElementById("toolboxeditor-title").innerText = i18n.__("Toolbox");
...
document.getElementById("splititle").innerText = i18n.__("Zone Controls:");
document.getElementById("splititle2").innerText = i18n.__("Splines:");
